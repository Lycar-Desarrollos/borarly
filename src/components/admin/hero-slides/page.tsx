            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-2 flex items-center gap-4">
                    <div className="w-48 h-20 relative border rounded bg-white flex items-center justify-center">
                        {imagePreview ? (
                            <NextImage src={imagePreview} alt="Vista previa" layout="fill" objectFit="contain" />
                        ) : (
              ...
              <TableBody>
                {slides.length > 0 ? slides.map((slide) => (
                  <TableRow key={slide.id}>
                    <TableCell>
                      <div className="w-20 h-10 relative border rounded overflow-hidden bg-white">
                        <NextImage src={slide.imageUrl} alt={slide.altText} layout="fill" objectFit="contain" data-ai-hint="slide admin table"/>
                      </div>
                    </TableCell>
