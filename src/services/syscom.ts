...
export const FALLBACK_CATEGORIES: Category[] = [
  ...
  { id: 'cableado', name: 'Cableado Estructurado', description: 'Cable UTP, patch cords, racks y gabinetes', isFeatured: true, featuredImageUrl: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=800&auto=format&fit=crop', parentId: null, level: 1 },
...
export function getCategoryImageByName(nombre: string): string {
    ...
    if (n.includes('cable') || n.includes('fibra') || n.includes('estructurado')) return 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=800&auto=format&fit=crop';
